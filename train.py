...
class VideoDescriptionTrain(object):
    ...
    def preprocessing(self):
        ...
        """
        TRAIN_LABEL_PATH = os.path.join(self.train_path,'captions','msvd_train.json')
        ...
        for y in y_data:
            for caption in y['caption']:
                ...
                if len(caption.split()) > 10 or len(caption.split()) < 6:
                    ...
                    train_list.append([caption, y['video_id']])
        ...
        for filename in os.listdir(TRAIN_FEATURE_DIR):
            ...
            video_id = filename.replace(".avi.npy", "")
            self.x_data[video_id] = f
    ...
    def train_model(self):
        ...
        encoder_outputs_input = Input(shape=(config.time_steps_encoder, self.latent_dim))
        ...
        self.decoder_model = Model([decoder_inputs,encoder_outputs_input,decoder_state_input_h,decoder_state_input_c],[decoder_outputs,state_h,state_c])
